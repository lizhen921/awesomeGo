...
select biz_id,biz_type,chezhan_id,chezhan_title,jump_url,start_time, end_time from rcm_pool.tb_active_pool where biz_type in (1,3,12,13,14,15,35,59,69) and is_delete = 0 and chezhan_id = 104 and chezhan_title is not null and start_time <= current_timestamp and end_time > current_timestamp order by start_time desc
...
select biz_id,biz_type,title,skis_first,author_icon,author_id,author,author_role,cms_series_ids,nlp_tags_choose,cities,jump_url,img_url2,cms_tags,modify_time,recommend_time ,create_at from rcm_pool.tb_richmedia_pool where is_delete = 0 and biz_type=50
...
select biz_id,biz_type,title,img_url,img_url2,jump_url,cms_series_ids,car_brand_ids,car_brand_names,view_count,modify_time,recommend_time,publish_time,create_at,popularity,refine,media_type,merchant_id from rcm_pool.tb_active_pool where is_delete = 0 and biz_type=51
...
select biz_id,biz_type,title,img_url,summary,cms_series_ids,city,city_id,popularity,circle_member,modify_time,publish_time,recommend_time,create_at from rcm_pool.tb_richmedia_pool where is_delete = 0 and biz_type = 48
...
select biz_id,biz_type,img_url,jump_url,modify_time,recommend_time,cms_series_ids,city,min_price,create_at,city_id,title from rcm_pool.tb_car_pool where is_delete = 0 and biz_type=52
...
select biz_id,biz_type,img_url,jump_url,modify_time,recommend_time,cms_series_ids,city,min_price,shoufu_price ,create_at from rcm_pool.tb_car_pool where is_delete = 0 and biz_type=53
...
select biz_id,biz_type,img_url,modify_time,recommend_time,publish_time,cms_series_ids,info_obj ,create_at from rcm_pool.tb_car_pool where is_delete = 0 and biz_type=54
...
select biz_id,biz_type,img_url,img_url2,modify_time,recommend_time,cms_series_ids,info_obj,rn ,create_at,title from rcm_pool.tb_active_pool where is_delete = 0 and biz_type=55
...
select biz_id,biz_type,img_url,img_url2,modify_time,recommend_time,cms_series_ids,info_obj ,create_at,is_new_energy,jump_url2,view_count,title_template,price_template,button_text,displaytype,series_score,summary from rcm_pool.tb_car_pool where is_delete = 0 and biz_type=56
...
select biz_id,biz_type,img_url,img_url2,modify_time,recommend_time,cms_series_ids,info_obj,update_at ,create_at from rcm_pool.tb_car_pool where is_delete = 0 and biz_type=57
...
SELECT a.biz_id,a.biz_type,a.title,a.cities,a.modify_time,a.recommend_time,a.jump_url,a.img_url,a.platform,a.img_url2,a.create_at,b.content from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE is_delete=0 AND biz_type=60
...
select biz_id,biz_type,sub_biz_id,sub_biz_name,title,jump_url,img_url,modify_time,end_time,cities,cms_series_ids,car_brand_ids,graphic_img_list,update_at ,create_at from rcm_pool.tb_active_pool where is_delete = 0 and biz_type =62
...
select biz_id,biz_type,title,img_url,img_url2,jump_url,index_detail,page_index,cms_content_class,reply_count,show_big_img,refine,cms_series_ids,cms_tags,nlp_tags_choose,modify_time,recommend_time,publish_time,v_id,author,author_icon,play_count,duration from rcm_pool.tb_richmedia_pool where is_delete=0 and date_add(current_timestamp,interval -35 day)<recommend_time and biz_type = 66
...
select biz_id, biz_type, title, img_url, img_url2, jump_url, index_detail, page_index, cms_content_class, play_count, show_big_img, refine, cms_series_ids, cms_tags, nlp_tags_choose, modify_time, publish_time, recommend_time, create_at, duration, v_id, reply_count, author, author_icon, nlp_tags_choose2 from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0 and biz_type =73
...
SELECT a.biz_id,a.biz_type,a.jump_url,a.title,a.cms_tags,a.reply_count,a.page_index,a.index_detail,a.cms_content_class,b.content,a.view_count,a.cms_series_ids,a.refine,a.tuijianforapp,a.img_url,a.graphic_img_list,a.publish_time,a.modify_time from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE is_delete=0 AND date_add(CURRENT_TIMESTAMP,INTERVAL-45 DAY)< recommend_time AND biz_type=74
...
select biz_id, biz_type, title, img_url, view_count, modify_time, publish_time, recommend_time, create_at, update_at from rcm_pool.tb_user_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0 and biz_type=83
...
select biz_id,biz_type,title,img_url,img_url2, is_new_energy, info_obj, cms_series_ids, cms_spec_ids, publish_time, recommend_time, update_at, create_at from rcm_pool.tb_car_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0 and biz_type =89
...
select biz_id,biz_type,title,recommend_time,reply_count,view_count,cms_tags,img_url,modify_time,update_at, picitems,create_at,author_id,city_ids from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete =0 and biz_type =25
...
select biz_id,biz_type,title,author,publish_time,img_url2 as img_url,modify_time,update_time,recommend_time,summary,reply_count,view_count ,img_url2,pk_id,pk_obj,vote_id,vote_obj, create_at from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -30 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and pk_obj is not NULL and biz_type =26
...
select biz_id,biz_type,img_url2,jump_url,modify_time,recommend_time,title,city,cms_tags,platform,create_at from rcm_pool.tb_car_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete =0 and biz_type =28
...
select biz_id,biz_type,title,img_url, img_url2,cms_series_ids,cms_spec_ids,city_id,city,modify_time,view_count,publish_time,update_at,recommend_time,jump_url ,create_at from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -30 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and biz_type = 36
...
select biz_id,biz_type,title,img_url, img_url2,car_brand_ids,car_brand_names,city,modify_time,publish_time,update_at,recommend_time,jump_url ,create_at,cms_series_ids from rcm_pool.tb_active_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and biz_type = 30
...
select biz_id,biz_type,img_url,img_url2,jump_url,title,city,publish_time,recommend_time,modify_time,start_time,end_time,cms_car_price,create_at,cms_series_ids,cms_spec_ids from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and active_start_time <= current_timestamp and active_end_time >= current_timestamp and date_add(current_timestamp,interval -30 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and biz_type = 29
...
select biz_id,biz_type,img_url,img_url2,title,city,publish_time,recommend_time,modify_time,reply_count,jump_url,create_at from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and biz_type = 31
...
SELECT a.biz_id,a.biz_type,a.title,a.recommend_time,a.reply_count,a.view_count,a.cms_series_ids,a.cms_tags,a.cms_content_class,a.img_url,a.index_detail,a.modify_time,a.graphic_img_list,a.subject_id,a.is_close_comment,a.skis_first,a.img_url2,a.duration,a.author,a.show_big_img,b.content,a.publish_time,a.author_id,a.v_id,a.youku_id,a.create_at from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE recommend_time<=CURRENT_TIMESTAMP AND recommend_time IS NOT NULL AND recommend_time !='' AND is_delete=0 AND biz_type=39
...
select biz_id,biz_type,title,img_url,img_url2,cms_tags,spec_kb_score,spec_feature,view_count,reply_count,cms_series_ids,cms_series_names,cms_spec_ids, cms_spec_names,jump_url, modify_time, recommend_time,update_at  ,create_at from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete= 0 and biz_type = 43
...
select biz_id,biz_type,title,jump_url,img_url,modify_time,publish_time,cms_series_ids,cms_spec_ids,view_count,popularity,recommend_time,update_at ,create_at from rcm_pool.tb_car_pool where is_delete = 0 and date_add(current_timestamp,interval -35 day) < recommend_time and biz_type = 59
...
select biz_id,biz_type,title,jump_url,cms_series_ids,cms_spec_ids,view_count,publish_time,update_at,create_at,graphic_img_list from rcm_pool.tb_active_pool where publish_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < publish_time and is_delete= 0 and biz_type = 61
...
SELECT a.biz_id,a.biz_type,a.title,b.content,a.img_url,a.img_url2,a.jump_url,a.graphic_img_list,a.author_id,a.view_count,a.reply_count,a.refine,a.is_video,a.modify_time,a.recommend_time,a.cms_tags,a.page_index,a.index_detail,a.cms_content_class,a.create_at from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE date_add(CURRENT_TIMESTAMP,INTERVAL-25 DAY)< recommend_time AND is_delete=0 AND biz_type=63



select biz_id, biz_type, title, img_url, img_url2, jump_url, index_detail, page_index, cms_content_class, play_count, show_big_img, refine, cms_series_ids, cms_tags, nlp_tags_choose, modify_time, publish_time, recommend_time, create_at, duration, v_id, reply_count, author, author_icon from rcm_pool.qingshaonian_luntanvideo where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0
select biz_id, biz_type, title, img_url, img_url2, jump_url, index_detail, page_index, cms_content_class, play_count, show_big_img, refine, cms_series_ids, cms_tags, nlp_tags_choose, modify_time, publish_time, recommend_time, create_at, duration, v_id, reply_count, author, author_icon from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0 and biz_type = 73
...
SELECT a.biz_id,a.biz_type,a.title,a.author_icon,a.author,a.author_id,a.cms_series_ids,a.modify_time,a.recommend_time,a.update_at,a.jump_url,a.img_url3,a.img_url2,a.cms_tags,a.show_big_img,a.popularity,a.reply_count,a.view_count,b.content,a.live_line,a.subject_id,a.summary,a.share_url,a.geo_point,a.img_url,a.duration,a.video_width,a.video_height,a.img_url4,a.create_at,a.live_albumname,a.author_role from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE is_delete=0 AND title !="" AND ((img_url2 IS NOT NULL AND img_url2 !="") OR (img_url4 IS NOT NULL AND img_url4 !="")) AND date_add(CURRENT_TIMESTAMP,INTERVAL-35 DAY)< recommend_time AND (refine=1 OR date_add(CURRENT_TIMESTAMP,INTERVAL-24 HOUR)< recommend_time) AND biz_type=68
...
select biz_id,biz_type,title,jump_url,img_url,modify_time,cms_series_ids,graphic_img_list,reply_count,recommend_time,update_at ,create_at from rcm_pool.tb_car_pool where is_delete = 0 and date_add(current_timestamp,interval -35 day) < recommend_time and tbl_id = 47
...
select biz_id,biz_type,live_line,jump_url,jump_url2,img_url,title,slogan,cms_series_ids,cms_spec_ids,dealer_id,citys,sale_price,suggest_price,dikouquan_price,dikouquanyi_price,yigoumai_num,is_fenqi,modify_time,publish_time,recommend_time,create_at,update_at,shoufu_price,source,is_mengzhu,media_type from rcm_pool.tb_car_pool where is_delete=0 and date_add(current_timestamp,interval -35 day)<recommend_time and (suggest_price-sale_price) > 12000 and sale_price > 10000 and biz_type = 70
...
select biz_id,biz_type,jump_url,img_url,title,cms_series_ids,cms_spec_ids,cms_car_price,sale_price,meter_mileage,city_ids,modify_time,publish_time,create_at,update_at,cheyuan_score,price_template,title_template from rcm_pool.tb_car_pool WHERE is_delete = 0 AND jump_listurl2 IS NOT NULL AND jump_listurl2 != '' AND title_template IS NOT NULL AND price_template IS NOT NULL and biz_type = 71
...
select biz_id,biz_type,jump_url,title,author_icon,summary,cms_series_ids,city_id,cms_tags,circle_member,refine,modify_time,publish_time,recommend_time,img_url,img_url2,graphic_img_list, create_at from rcm_pool.tb_richmedia_pool where is_delete=0 and biz_type = 76
...
select biz_id,biz_type,title,img_url2,jump_url,publish_time,update_at,create_at,img_url from rcm_pool.tb_richmedia_pool where is_delete = 0 and biz_type = 77
...
select biz_id,biz_type,title,img_url2,jump_url,publish_time,update_at,create_at,img_url from rcm_pool.tb_richmedia_pool where is_delete = 0 and biz_type = 78
...
select biz_id,biz_type,jump_url,title,view_count,img_url,img_url2,modify_time,recommend_time, create_at from rcm_pool.tb_richmedia_pool where is_delete=0 and date_add(current_timestamp,interval -45 day)<recommend_time and biz_type = 79
...
select biz_id,biz_type,title,img_url,img_url2,jump_url,cms_series_ids,cms_series_names,spec_kb_score,reply_count,refine,min_price,max_price,cms_level_ids,cms_level_names,popularity,publish_time,update_at,create_at from rcm_pool.tb_richmedia_pool where publish_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < publish_time and is_delete= 0 and biz_type = 80
...
SELECT a.biz_id,a.biz_type,a.title,a.img_url,a.img_url2,a.jump_url,a.cms_series_ids,a.refine,a.reply_count,b.content,a.publish_time,a.update_at,a.create_at from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE publish_time<=CURRENT_TIMESTAMP AND date_add(CURRENT_TIMESTAMP,INTERVAL-35 DAY)< publish_time AND is_delete=0 AND biz_type=81 AND (refine=1 OR refine=2)
...
select biz_id,biz_type,title,jump_url,img_url2,graphic_img_list,refine,cms_series_ids,author_id,author,view_count,info_obj,publish_time,create_at,update_at,img_url from rcm_pool.tb_user_pool where publish_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < publish_time and is_delete= 0 and biz_type = 86
...
select biz_id,biz_type,title,jump_url,img_url,cms_tags,cms_series_ids,view_count,reply_count,publish_time,create_at,update_at from rcm_pool.tb_user_pool where publish_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < publish_time and is_delete= 0 and biz_type = 87
...
select biz_type, biz_id, title, img_url2, cms_series_ids, cms_tags, graphic_img_list, show_big_img, refine, media_type, jump_url, publish_time, recommend_time, update_at, create_at from rcm_pool.tb_active_pool where date_add(current_timestamp,interval -35 day)<recommend_time and refine=1 and is_delete=0  and biz_type = 93
...
select biz_id, biz_type, title, jump_url, img_url, img_url2, cms_series_ids, cities, view_count, publish_time, recommend_time, create_at, update_at from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0  and biz_type = 94
...
select biz_id, biz_type, title, img_url, view_count, jump_url2, publish_time, recommend_time, modify_time, create_at, update_at, cms_series_ids, refine from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete= 0  and biz_type =95
...
SELECT a.biz_id,a.biz_type,a.title,a.img_url,a.jump_url,b.content,a.index_detail,a.cms_tags,a.cms_series_ids,a.recommend_time,a.nlp_tags,a.nlp_series,a.nlp_keyword from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE date_add(CURRENT_TIMESTAMP,INTERVAL-35 DAY)< recommend_time AND is_delete=0 AND biz_type=200
...
select biz_id, biz_type, popularity, graphic_img_list, jump_url, img_url, title, cms_tags, media_type, publish_time, recommend_time, create_at, update_at,cms_series_ids,refine from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete = 0 and media_type = 1  and biz_type = 201
...
select biz_id, biz_type, graphic_img_list, jump_url, title, cms_tags, reply_count, media_type, publish_time, recommend_time, create_at, update_at,cms_series_ids,refine,rn from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete = 0  and biz_type =202
...
select biz_type,biz_id,title,jump_url,jump_url2,publish_time,view_count,img_url2,author_icon,show_big_img,recommend_time,update_at,create_at from rcm_pool.tb_active_pool where is_delete=0  and biz_type = 203
...
SELECT a.biz_type,a.biz_id,a.title,a.author,a.author_id,a.img_url,a.summary,a.reply_count,a.view_count,a.content,a.cms_series_ids,a.cms_tags,a.category_tags,a.graphic_img_list,a.author_icon,a.cms_series_names,a.car_brand_ids,a.car_brand_names,a.jump_url,a.cities,a.jump_url2,a.nlp_tags_choose2,a.publish_time,a.recommend_time,a.create_at,a.update_at from rcm_pool.tb_richmedia_pool a LEFT JOIN resource_content b ON a.object_uid=b.object_uid WHERE date_add(CURRENT_TIMESTAMP,INTERVAL-35 DAY)< recommend_time AND is_delete=0 AND (refine=1 OR refine=3) AND biz_type=206
...
select biz_type,biz_id,title,jump_url,jump_url2,publish_time,view_count,img_url2,author_icon,show_big_img,recommend_time,update_at ,create_at from rcm_pool.tb_active_pool where is_delete=0  and biz_type = 204
...
select biz_type, biz_id, author_icon, author, author_id, editor_id, live_line, summary, jump_url, publish_time, modify_time, recommend_time from rcm_pool.tb_user_pool where is_delete = 0  and biz_type = 205
...
select biz_id, biz_type, graphic_img_list, jump_url, img_url, title,reply_count,  publish_time, recommend_time, create_at, update_at,cms_series_ids from rcm_pool.tb_car_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete = 0 and biz_type = 208
...
select biz_type,biz_id,title,jump_url,img_url2,graphic_img_list,cms_series_ids,cms_spec_ids,city_ids,merchant_id,view_count,cms_tags,show_big_img,publish_time,create_at,update_at from rcm_pool.tb_user_pool where is_delete = 0 and biz_type = 210
...
select biz_type, biz_id, title, jump_url, img_url2 , abstract, author_icon, publish_time, recommend_time, create_at, update_at from rcm_pool.tb_active_pool where is_delete = 0 AND date_add(current_timestamp, INTERVAL -35 DAY)  and biz_type = 211
...
select biz_id,biz_type,title,recommend_time,reply_count,view_count,cms_tags,img_url,modify_time,update_at, picitems, create_at, author_id, city_ids, source, jump_url2 from rcm_pool.tb_richmedia_pool where recommend_time<= current_timestamp and date_add(current_timestamp,interval -35 day) < recommend_time and recommend_time is not null and recommend_time!='' and is_delete =0 and biz_type = 212
...
select biz_id, biz_type, title, img_url, cms_series_ids, view_count, jump_url, index_detail, publish_time, recommend_time, create_at, update_at from rcm_pool.tb_car_pool where is_delete = 0 and date_add(current_timestamp,interval -35 day) < recommend_time and biz_type = 213
...
select biz_id, biz_type, title, modify_time, recommend_time, publish_time, img_url, graphic_img_list, cms_series_ids, cities, view_count, jump_url,index_detail, cms_tags,nlp_tags_choose2, create_at, update_at, reply_count from rcm_pool.tb_richmedia_pool where date_add(current_timestamp,interval -35 day) < recommend_time and is_delete = 0  and biz_type = 214
...
select biz_id, biz_type, title, img_url, index_detail, abstract, graphic_img_list, cms_series_ids, cms_tags, jump_url, jump_url2, publish_time, recommend_time, update_at, create_at from rcm_pool.tb_richmedia_pool where biz_type=215 and is_delete = 0 and date_add(current_timestamp,interval -35 day) < recommend_time
...
select biz_id, biz_type, img_url2, title, jump_url, view_count, publish_time, create_at, update_at from rcm_pool.tb_richmedia_pool where is_delete = 0 and biz_type = 10001
